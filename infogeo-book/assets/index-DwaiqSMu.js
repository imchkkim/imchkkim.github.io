const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ch01-why-fvsQjI1X.js","assets/components-kOt0SgG8.js","assets/ch02-point-a8C4d8Pe.js","assets/ch03-distance-CBgNOtXI.js","assets/math-utils-DGi4yakc.js","assets/log-DP1sRD85.js","assets/linear-BAq6rIIX.js","assets/max-C7l7KFzs.js","assets/ch04-paths-cQWVTyiJ.js","assets/ch05-surprise-and-information-CTrxjltw.js","assets/ch06-convex-duality-DOJL2y6W.js","assets/ch07-exponential-family-flashcards-CDvsj8wy.js","assets/range-OtVwhkKS.js","assets/ch08-curved-land-DhU7kdWG.js","assets/ch09-fisher-information-qYSxiNXK.js","assets/ch10-ignorance-confidence-Bb2GheD7.js","assets/ch11-geometry-of-inference-Bgup5VCc.js","assets/ch12-convergence-CopxsIVc.js","assets/ch13-full-map-7EnTNSHM.js","assets/ch14-diffusion-DV7_zmRF.js","assets/ch15-flow-matching-BF6NVV4M.js","assets/ch16-broadening-narrowing-BCthHPjZ.js","assets/ch17-scaling-DQPNW8PD.js"])))=>i.map(i=>d[i]);
 ...
 *
 * @license MIT
 */function qa(){return qa=Object.assign?Object.assign.bind():function(a){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var o in r)Object.prototype.hasOwnProperty.call(r,o)&&(a[o]=r[o])}return a},qa.apply(this,arguments)}const bu=Q.createContext(null),Z4=Q.createContext(null),zr=Q.createContext(null),go=Q.createContext(null),Vn=Q.createContext({outlet:null,matches:[],isDataRoute:!1}),Wf=Q.createContext(null);function Q4(a,t){let{relative:r}=t===void 0?{}:t;F0()||ct(!1);let{basename:o,navigator:i}=Q.useContext(zr),{hash:u,pathname:p,search:d}=Qf(a,{relative:r}),x=p;return o!=="/"&&(x=p==="/"?o:yr([o,p])),i.createHref({pathname:x,search:d,hash:u})}function F0(){return Q.useContext(go)!=null}function M0(){return F0()||ct(!1),Q.useContext(go).location}function Xf(a){Q.useContext(zr).static||Q.useLayoutEffect(a)}function Zf(){let{isDataRoute:a}=Q.useContext(Vn);return a?pm():Y4()}function Y4(){F0()||ct(!1);let a=Q.useContext(bu),{basename:t,future:r,navigator:o}=Q.useContext(zr),{matches:i}=Q.useContext(Vn),{pathname:u}=M0(),p=JSON.stringify(gu(i,r.v7_relativeSplatPath)),d=Q.useRef(!1);return Xf(()=>{d.current=!0}),Q.useCallback(function(g,y){if(y===void 0&&(y={}),!d.current)return;if(typeof g=="number"){o.go(g);return}let k=vu(g,JSON.parse(p),u,y.relative==="path");a==null&&t!=="/"&&(k.pathname=k.pathname==="/"?t:yr([t,k.pathname])),(y.replace?o.replace:o.push)(k,y.state,y)},[t,o,p,u,a])}function J4(){let{matches:a}=Q.useContext(Vn),t=a[a.length-1];return t?t.params:{}}function Qf(a,t){let{relative:r}=t===void 0?{}:t,{future:o}=Q.useContext(zr),{matches:i}=Q.useContext(Vn),{pathname:u}=M0(),p=JSON.stringify(gu(i,o.v7_relativeSplatPath));return Q.useMemo(()=>vu(a,JSON.parse(p),u,r==="path"),[a,p,u,r])}function em(a,t){return tm(a,t)}function tm(a,t,r,o){F0()||ct(!1);let{navigator:i}=Q.useContext(zr),{matches:u}=Q.useContext(Vn),p=u[u.length-1],d=p?p.params:{};p&&p.pathname;let x=p?p.pathnameBase:"/";p&&p.route;let g=M0(),y;if(t){var k;let A=typeof t=="string"?Wr(t):t;x==="/"||(k=A.pathname)!=null&&k.startsWith(x)||ct(!1),y=A}else y=g;let L=y.pathname||"/",E=L;if(x!=="/"){let A=x.replace(/^\//,"").split("/");E="/"+L.replace(/^\//,"").split("/").slice(A.length).join("/")}let K=z4(a,{pathname:E}),C=om(K&&K.map(A=>Object.assign({},A,{params:Object.assign({},d,A.params),pathname:yr([x,i.encodeLocation?i.encodeLocation(A.pathname).pathname:A.pathname]),pathnameBase:A.pathnameBase==="/"?x:yr([x,i.encodeLocation?i.encodeLocation(A.pathnameBase).pathname:A.pathnameBase])})),u,r,o);return t&&C?Q.createElement(go.Provider,{value:{location:qa({pathname:"/",search:"",hash:"",state:null,key:"default"},y),navigationType:gr.Pop}},C):C}function nm(){let a=cm(),t=W4(a)?a.status+" "+a.statusText:a instanceof Error?a.message:JSON.stringify(a),r=a instanceof Error?a.stack:null,i={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"};return Q.createElement(Q.Fragment,null,Q.createElement("h2",null,"Unexpected Application Error!"),Q.createElement("h3",{style:{fontStyle:"italic"}},t),r?Q.createElement("pre",{style:i},r):null,null)}const rm=Q.createElement(nm,null);class am extends Q.Component{constructor(t){super(t),this.state={location:t.location,revalidation:t.revalidation,error:t.error}}static getDerivedStateFromError(t){return{error:t}}static getDerivedStateFromProps(t,r){return r.location!==t.location||r.revalidation!=="idle"&&t.revalidation==="idle"?{error:t.error,location:t.location,revalidation:t.revalidation}:{error:t.error!==void 0?t.error:r.error,location:r.location,revalidation:t.revalidation||r.revalidation}}componentDidCatch(t,r){console.error("React Router caught the following error during render",t,r)}render(){return this.state.error!==void 0?Q.createElement(Vn.Provider,{value:this.props.routeContext},Q.createElement(Wf.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function lm(a){let{routeContext:t,match:r,children:o}=a,i=Q.useContext(bu);return i&&i.static&&i.staticContext&&(r.route.errorElement||r.route.ErrorBoundary)&&(i.staticContext._deepestRenderedBoundaryId=r.route.id),Q.createElement(Vn.Provider,{value:t},o)}function om(a,t,r,o){var i;if(t===void 0&&(t=[]),r===void 0&&(r=null),o===void 0&&(o=null),a==null){var u;if(!r)return null;if(r.errors)a=r.matches;else if((u=o)!=null&&u.v7_partialHydration&&t.length===0&&!r.initialized&&r.matches.length>0)a=r.matches;else return null}let p=a,d=(i=r)==null?void 0:i.errors;if(d!=null){let y=p.findIndex(k=>k.route.id&&(d==null?void 0:d[k.route.id])!==void 0);y>=0||ct(!1),p=p.slice(0,Math.min(p.length,y+1))}let x=!1,g=-1;if(r&&o&&o.v7_partialHydration)for(let y=0;y<p.length;y++){let k=p[y];if((k.route.HydrateFallback||k.route.hydrateFallbackElement)&&(g=y),k.route.id){let{loaderData:L,errors:E}=r,K=k.route.loader&&L[k.route.id]===void 0&&(!E||E[k.route.id]===void 0);if(k.route.lazy||K){x=!0,g>=0?p=p.slice(0,g+1):p=[p[0]];break}}}return p.reduceRight((y,k,L)=>{let E,K=!1,C=null,A=null;r&&(E=d&&k.route.id?d[k.route.id]:void 0,C=k.route.errorElement||rm,x&&(g<0&&L===0?(fm("route-fallback"),K=!0,A=null):g===L&&(K=!0,A=k.route.hydrateFallbackElement||null)));let P=t.concat(p.slice(0,L+1)),V=()=>{let Z;return E?Z=C:K?Z=A:k.route.Component?Z=Q.createElement(k.route.Component,null):k.route.element?Z=k.route.element:Z=y,Q.createElement(lm,{match:k,routeContext:{outlet:y,matches:P,isDataRoute:r!=null},children:Z})};return r&&(k.route.ErrorBoundary||k.route.errorElement||L===0)?Q.createElement(am,{location:r.location,revalidation:r.revalidation,component:C,error:E,children:V(),routeContext:{outlet:null,matches:P,isDataRoute:!0}}):V()},null)}var Yf=(function(a){return a.UseBlocker="useBlocker",a.UseRevalidator="useRevalidator",a.UseNavigateStable="useNavigate",a})(Yf||{}),Jf=(function(a){return a.UseBlocker="useBlocker",a.UseLoaderData="useLoaderData",a.UseActionData="useActionData",a.UseRouteError="useRouteError",a.UseNavigation="useNavigation",a.UseRouteLoaderData="useRouteLoaderData",a.UseMatches="useMatches",a.UseRevalidator="useRevalidator",a.UseNavigateStable="useNavigate",a.UseRouteId="useRouteId",a})(Jf||{});function im(a){let t=Q.useContext(bu);return t||ct(!1),t}function sm(a){let t=Q.useContext(Z4);return t||ct(!1),t}function um(a){let t=Q.useContext(Vn);return t||ct(!1),t}function e2(a){let t=um(),r=t.matches[t.matches.length-1];return r.route.id||ct(!1),r.route.id}function cm(){var a;let t=Q.useContext(Wf),r=sm(),o=e2();return t!==void 0?t:(a=r.errors)==null?void 0:a[o]}function pm(){let{router:a}=im(Yf.UseNavigateStable),t=e2(Jf.UseNavigateStable),r=Q.useRef(!1);return Xf(()=>{r.current=!0}),Q.useCallback(function(i,u){u===void 0&&(u={}),r.current&&(typeof i=="number"?a.navigate(i):a.navigate(i,qa({fromRouteId:t},u)))},[a,t])}const $p={};function fm(a,t,r){$p[a]||($p[a]=!0)}function dm(a,t){a==null||a.v7_startTransition,a==null||a.v7_relativeSplatPath}function hm(a){let{to:t,replace:r,state:o,relative:i}=a;F0()||ct(!1);let{future:u,static:p}=Q.useContext(zr),{matches:d}=Q.useContext(Vn),{pathname:x}=M0(),g=Zf(),y=vu(t,gu(d,u.v7_relativeSplatPath),x,i==="path"),k=JSON.stringify(y);return Q.useEffect(()=>g(JSON.parse(k),{replace:r,state:o,relative:i}),[g,k,i,r,o]),null}function lo(a){ct(!1)}function mm(a){let{basename:t="/",children:r=null,location:o,navigationType:i=gr.Pop,navigator:u,static:p=!1,future:d}=a;F0()&&ct(!1);let x=t.replace(/^\/*/,"/"),g=Q.useMemo(()=>({basename:x,navigator:u,static:p,future:qa({v7_relativeSplatPath:!1},d)}),[x,d,u,p]);typeof o=="string"&&(o=Wr(o));let{pathname:y="/",search:k="",hash:L="",state:E=null,key:K="default"}=o,C=Q.useMemo(()=>{let A=xu(y,x);return A==null?null:{location:{pathname:A,search:k,hash:L,state:E,key:K},navigationType:i}},[x,y,k,L,E,K,i]);return C==null?null:Q.createElement(zr.Provider,{value:g},Q.createElement(go.Provider,{children:r,value:C}))}function xm(a){let{children:t,location:r}=a;return em(Vs(t),r)}new Promise(()=>{});function Vs(a,t){t===void 0&&(t=[]);let r=[];return Q.Children.forEach(a,(o,i)=>{if(!Q.isValidElement(o))return;let u=[...t,i];if(o.type===Q.Fragment){r.push.apply(r,Vs(o.props.children,u));return}o.type!==lo&&ct(!1),!o.props.index||!o.props.children||ct(!1);let p={id:o.props.id||u.join("-"),caseSensitive:o.props.caseSensitive,element:o.props.element,Component:o.props.Component,index:o.props.index,path:o.props.path,loader:o.props.loader,action:o.props.action,errorElement:o.props.errorElement,ErrorBoundary:o.props.ErrorBoundary,hasErrorBoundary:o.props.ErrorBoundary!=null||o.props.errorElement!=null,shouldRevalidate:o.props.shouldRevalidate,handle:o.props.handle,lazy:o.props.lazy};o.props.children&&(p.children=Vs(o.props.children,u)),r.push(p)}),r}/**
...
"정보"는 오랫동안 일상어였다. 1948년, 벨 연구소의 클로드 섀넌이 이 단어에 정확한 숫자를 매겼다. 드문 일이 일어나면 많이 놀라고, 흔한 일이 일어나면 적게 놀란다. 그 놀라움의 평균이 엔트로피이고, 엔트로피는 메시지를 아무리 영리하게 줄여 적어도 넘을 수 없는 평균 길이의 한계다. 놀라움, 엔트로피, 코드의 길이가 하나로 이어졌다.
...
앞에서 본 마법들도 이 지도 위에 자리가 있다. 두 모델의 가운데를 취하는 일은 덧셈과 곱셈의 "두 개의 길"과, 분포를 가장 가까운 점으로 내리는 사영으로. LoRA가 좁은 방향으로 움직여도 되는 이유는 넓은 공간 속 얇은 곡면, 매니폴드로. 같은 한 걸음이 곳에 따라 다른 변화를 만드는 이유는 Fisher 정보로. 노이즈에서 그림을 꺼내는 생성 모델은 분포와 분포를 잇는 길로.
...
〔S09〕 **이서연:** 그래서 앞에서 서울역 사람들이 구석이 아니라 벽을 따라 서 있다고 한 거군요. 수업에서 고차원 공의 부피가 거의 다 껍질에 있다는 걸 배웠을 때도, 그게 "극점 근처"라는 뜻은 아니었어요. 껍질은 넓고 극점은 좁으니까요.
...
KL은 거리의 네 약속 중 첫 두 개는 지킨다. 항상 0 이상이고, 0이면 두 분포가 같다. 하지만 대칭이 아니고, 아래 문제 4에서 보겠지만 삼각부등식도 깨진다. 그래서 수학자들은 이것을 거리(distance)라 부르지 않고 발산(divergence)이라 부른다. "한 점에서 다른 점으로 벌어져 나가는 정도"라는 뜻이다. 이 책에서 "KL 거리"라고 말할 때도 속뜻은 늘 발산이다.

{{viz: ch03/asymmetry}}

### ML에서: 교차 엔트로피 손실은 KL(p‖q)다

분류 모델을 학습시킬 때 흔히 쓰는 교차 엔트로피 손실 −Σ p<sub>i</sub> log q<sub>i</sub> 를 KL의 정의와 나란히 놓아 보자. KL(p‖q) = Σ p<sub>i</sub> log p<sub>i</sub> − Σ p<sub>i</sub> log q<sub>i</sub> 이므로, 교차 엔트로피는 KL(p‖q)에 모형 q와 상관없는 값 −Σ p<sub>i</sub> log p<sub>i</sub> 를 더한 것이다. 그래서 교차 엔트로피를 줄이는 일은 데이터를 현실 자리에, 모델을 모형 자리에 둔 KL(p‖q)를 줄이는 일과 같다. 학습은 방향을 이미 골라 놓고 있는 셈이다.
...
앞 절의 합은 키처럼 연속인 값에서는 적분이 된다. 정규분포끼리는 그 적분이 닫힌 식으로 풀린다.
...
결과가 셋이면 분포는 색도 삼각형 같은 심플렉스 위의 점이다. m-길 위의 점은 두 끝점을 잇는 선분 위를 등속으로 걷는다. 각 칸의 확률이 t에 대해 일차식이기 때문이다. 확률 자체가 좌표인 지도에서 이 길은 곧은 선이다.
...
**선생님:** 그래요. 로그는 밑을 바꿔도 상수배만 달라져요. 정보량을 잴 때 쓰는 bit와 nat도 바로 그 상수배의 차이예요.
...
한 가지 조심할 것이 있다. "e-중간점은 언제나 m-중간점보다 뾰족하다"는 봉우리 두 개인 이 무대에서만 맞다. 결과가 셋뿐인 분포에서는 자주 뒤집힌다. 앞 절의 a, b가 그렇다. 엔트로피가 m-중간점은 1.081, e-중간점은 1.098이다. e-중간점이 더 평평하다. 어느 쪽이 더 퍼지는지는 곱셈이 어느 칸을 깎느냐에 달렸다. 아래 문제 4에서 끝까지 따라간다.
...
거리를 재는 자는 여전히 하나다. Fisher 정보가 만드는, 어느 쪽에서 재든 값이 같은 대칭인 자다. 그 자로 잰 최단 경로는 m-길도 e-길도 아닌 세 번째 길이다. e-길과 m-길은 "가장 짧은 길"이 아니라 각자의 규칙에서 "방향을 바꾸지 않고 곧게 가는 길"이다.
...
KL 발산이라는 비대칭 거리가 있다. 현실 p와 모형 q에 대해 KL(p‖q) = Σ p<sub>i</sub> log(p<sub>i</sub>/q<sub>i</sub>)는 숫자를 내뱉는다. 그런데 그 숫자가 정확히 무엇을 재는가? KL의 수식 안에는 log가 들어 있다. 왜 하필 log인가? 왜 KL은 늘 0 이상인가? 답은 "놀라움"이라는 개념에서 시작한다.
...
**선생님:** 그래요. 제약 아래 엔트로피를 가장 크게 하면 지수 꼴이 나와요. 지수족이라 부르는 분포 가족의 출발점이에요.
...
평균 음의 로그우도(NLL)가 곧 경험분포와의 교차엔트로피다. 그러니 최대우도추정(MLE)은 KL(p̂‖q<sub>θ</sub>)를 가장 작게 만드는 θ를 찾는 일이다. H(p̂)는 θ와 무관하기 때문이다. "내 모델이 현실에서 얼마나 먼가"라는 질문의 답이 여기 있다. 학습은 데이터가 그려 준 현실 p̂에서 모형까지의 KL을 줄이는 과정이다.
...
>
> 이 수렴이 우연이 아니라 필연이었다는 것은 1957년 E.T. Jaynes가 명시적으로 보여주었다. 통계역학과 정보이론이 같은 원리의 두 응용이라는 것을.
`,Om=`# 볼록함수의 쌍대

−log는 볼록함수다. 그리고 그 볼록성 하나에서 KL 발산이 늘 0 이상이라는 사실이 나온다. 하지만 −log는 하나의 볼록함수일 뿐이다. 볼록함수 자체가 가진 구조를 이해하면, 훨씬 더 많은 것이 보인다.
...
그리고 확률의 핵심 함수가 볼록이다. −log가 볼록하고, 지수족이라 부르는 분포 가족의 로그정규화자 F(θ)도 볼록하다. 르장드르 변환은 그 볼록 구조 위에서 태어난 번역기다.
...
eᶿ로 확인하면, F′(θ) = eᶿ 의 역함수는 log η 이고, (η log η − η)′ = log η 다. 맞는다. 기울기를 한 번 더 미분하면 곡률끼리도 짝이 맞는다: F″(θ) · (F*)″(η) = 1. 원본이 가파르게 휘는 곳에서 쌍대는 완만하게 휜다.
...
볼록함수 F가 있으면 그 기울기를 새 좌표로 삼을 수 있다. 기울기로 맞물린 짝에서는 F와 그 쌍대 F*의 합이 두 좌표의 곱이 된다. 역학에서도, 최적화에서도 이 구조가 되풀이해 나타난다.

그렇다면 이렇게 물을 수 있다. 만약 F가 확률분포에서 태어난 함수라면? 만약 θ가 분포의 모양을 결정하는 파라미터라면?
...
θ가 직관적이지 않은 대신 얻는 것이 있다. 두 분포의 로그를 섞은 뒤 다시 정규화하는 길, 곧 곱셈의 길이 θ 좌표에서 직선이 된다. log p와 log q를 (1−t) : t 로 섞으면 지수 안의 θ가 그대로 (1−t)θ_p + tθ_q 로 섞이기 때문이다.
...
두 번째 식은 F가 볼록함수라는 것을 보장한다. 공분산 행렬은 음수 방향이 없기 때문이다. 한 가지 조건이 있다. 미분과 합(적분)의 순서를 바꾸었으므로, θ가 자연모수 공간의 안쪽에 있어야 한다(아래 문제 2). F의 헤시안이 곧 θ 좌표의 피셔 정보라는 것도 여기서 한 번 봐 두자.

### η를 평균 내면 무엇이 되나

두 가우시안의 η를 반씩 평균 내면, 그것은 두 분포를 반반 섞은 혼합분포의 E[t(x)]와 같다. 기대값은 섞으면 섞인 대로 평균 나기 때문이다. 그러나 혼합분포 자체는 가우시안이 아니다. 봉우리가 둘일 수도 있다. 가우시안 가족 안에서 그 η를 주소로 갖는 한 명은, **혼합과 같은 평균·이차모멘트를 가진 가우시안**이다. 이것이 혼합분포를 가우시안 가족 위로 m-사영한 점, 곧 KL(혼합 ‖ q)를 가장 작게 하는 가우시안 q다(모멘트 일치).

결과가 유한한 범주분포(확률표) 전체에서는 사정이 다르다. 확률표끼리는 섞어도 확률표이므로, 거기서는 η-직선이 곧 혼합의 길이다. 가족이 섞기에 닫혀 있지 않으면, η-직선 위의 점은 "혼합의 대역"이다.
...
볼록함수 F가 있으면 기울기 η = ∇F(θ) 를 새 좌표로 삼고, 새 함수 F*(η) = θ·η − F(θ) 를 만들 수 있다. 이것을 르장드르 변환이라 부르고, F*를 F의 쌍대라고 한다. 역학에서 속도 v에서 운동량 p = ∂L/∂v 로 넘어갈 때 쓰는 것도 같은 변환이다. 기울기가 새 좌표가 된다. F가 볼록이라는 것은 앞 절에서 보았으니, 이 변환을 지수족에 그대로 쓸 수 있다.
...
앞 절에서, θ와 η를 서로 다른 분포에서 가져오면 펜셸–영 부등식에 틈이 생긴다고 했다. 그 틈은 볼록한 곡선과 접선 사이의 높이 차다. 한편 분포 사이의 차이를 재는 비대칭 거리로 우리는 KL 발산을 알고 있다. 둘은 혹시 같은 것 아닐까?
...
"KL 발산은 '로그정규화자와 그 접선 사이의 높이 차'였다. KL의 비대칭 거리, 볼록함수의 접선과 르장드르 변환, 지수족의 θ 좌표 — 세 갈래가 여기서 하나로 합류한다."
...
지수족의 θ 좌표와 η 좌표를 떠올려 보자. 이것은 같은 지구본에 메르카토르 도법과 정거원추도법을 각각 입힌 것과 같다. 같은 땅인데 지도가 다르다. 두 지도가 겹치는 영역에서의 좌표 변환 규칙 — 그것이 η = ∇F(θ), 르장드르 변환이다. θ에서 η로 건너간 일은 결국 좌표 변환이었다.
...
관절 인형의 자세는 3차원 공간에서 펼쳐지지만, 실제 자유도는 관절의 수뿐이다. 관절이 10개면 자유도는 10. 고차원 공간 속에 묻힌 10차원 매니폴드다.

### 언어 모델의 분포 — 심플렉스의 좁은 구석

어휘가 5만 개인 "다음 토큰" 분포는 심플렉스, 곧 49,999차원 초삼각형 위의 한 점이다. 그 위에 고르게 찍은 점은 거의 다 비슷한 모습이었다. 모든 칸이 1/n 근처이고, 가장 큰 칸도 (ln n)/n 정도라 어느 꼭짓점과도 멀며, 가장 작은 칸 하나가 1/n² 정도로 작아 경계의 면 가까이에 있다(측도의 집중).
...
KL 발산은 두 분포 사이의 '전역적 거리'를 잰다. 그런데 매니폴드 위를 걸어가면서 한 걸음 한 걸음의 크기를 재려면? 좌표의 한 칸은 어디서나 같은 거리일까?
...
이 자의 그림자는 KL 발산에 이미 있다. KL 발산을 무한히 가까운 두 점 사이에서 전개하면 대칭적인 이차형식이 되고, 그 이차형식을 만드는 행렬이 피셔 정보 행렬이다. 피셔 정보 행렬이 바로 이 "국소적 자"다. 각 지점에서 "한 걸음이 분포를 얼마나 바꾸는가"를 알려주는 행렬. 수학은 이런 국소적 자를 계량(metric)이라 부른다.
...
두 분포를 잇는 길에는 덧셈의 길(확률을 섞는 길)과 곱셈의 길(로그를 섞은 뒤 다시 정규화하는 길)이 있었다. 두 길의 "길이"를 비교하고 싶다면? 그러려면 각 지점에서 한 걸음의 크기를 알아야 한다. 같은 두 점 사이를 걸어가는데, 경로의 길이가 다른 이유는 두 가지다:
  ① 경로의 모양이 다르다
...
그러면 앞에서 말한 두 길, 덧셈의 길과 곱셈의 길은 무엇인가? 이 둘은 피셔 자로 잰 가장 짧은 길이 **아니다.** 자는 하나이고, 그 자가 정하는 가장 짧은 길도 하나다. 두 길은 다른 종류의 "곧음"을 따른다. 길이를 줄이는 대신, 방향을 바꾸지 않고 곧게 나아가는 길. 무엇을 "방향을 바꾸지 않는다"고 부를지 정하는 규칙이 따로 있고, 그 규칙이 둘이어서 곧은 길도 둘이다. 이 장의 마지막 절에서 그 규칙, 접속을 만난다.
...
### 볼록성이 주는 자 — 그릇의 오목한 정도

지수족의 로그정규화자 F(θ)는 볼록함수, 곧 "그릇"이다. 그릇의 오목한 정도(이계도함수)는 어디서나 같은가? 바닥이 넓은 그릇과 바닥이 좁은 그릇이 다르듯, F(θ)의 이계도함수도 θ에 따라 다르다. 그리고 F(θ)의 이계도함수(헤시안)가 바로 θ 좌표의 자, 곧 피셔 정보 행렬이다. 한 가지만 미리 짚자. 그릇이 오목한 정도는 자의 눈금이지, 공간의 곡률이 아니다. 둘을 가르는 것이 다음 절이다.
...
- α = +1 : e-접속. θ 좌표(자연모수)에서 곧은 길이 직선이다. 곱셈의 길.
- α = −1 : m-접속. η 좌표(기대모수)에서 곧은 길이 직선이다. 덧셈의 길.
...
좌표의 한 칸은 어디서나 같은 거리가 아니다. 그리고 그것만으로는 공간이 휘었다고 말할 수 없다. 한 칸의 크기는 자(ruler)의 눈금이고, 곡률은 그 자와 접속이 함께 정하는 안쪽의 양이다.

그러니 먼저 자가 필요하다. 확률분포의 공간에 놓을, 공정한 자.

그 자의 정체가 이 장에 있다. 제목은 "곡률"이지만 이 장의 주인공은 자, 피셔 계량이다. 곡률은 그 자에서 계산되는 한 가지 결과로 장 뒤쪽에서 나온다.

## 피셔 정보: 분포가 파라미터의 떨림을 느끼는 정도

같은 크기만큼 파라미터를 바꿔도, 어떤 분포는 거의 안 변하고 어떤 분포는 확 변한다. 이 '민감도'를 숫자로 쓸 수 있을까?

### 볼륨 다이얼 — 같은 1mm, 다른 변화

볼륨 다이얼을 1mm 돌렸을 때, 조용한 클래식 곡에서는 거의 차이가 안 들린다. 하지만 베이스가 꽉 찬 힙합 곡에서는 같은 1mm가 온 방을 울린다. 다이얼의 물리적 회전량은 같은데, 음악이 느끼는 변화의 크기가 다르다. 그 "느끼는 크기"가 Fisher 정보다.
...
정규분포 N(μ, σ²)에서 계산하면 μ 방향은 1/σ², σ 방향은 2/σ²이다(다음 절의 문제 2). 둘 다 σ가 작을수록 커진다. 뾰족한 분포는 파라미터 변화에 예민하다.
...
학습은 KL 발산을 줄이는 과정이다. KL을 줄이려면 파라미터를 바꿔야 한다. 그런데 얼마나 바꿔야 하는가? 민감한 영역에서는 조금만 바꿔도 분포가 크게 변한다 — 조심해야 한다. 둔감한 영역에서는 많이 바꿔도 분포가 별로 안 변한다 — 과감해도 된다. Fisher 정보는 이 "조심함의 정도"를 알려준다. 이것이 나중에 자연 기울기(natural gradient)의 핵심이 된다.
...
KL 발산을 아주 가까운 두 분포 사이에서 전개하면 비대칭이 사라지고 대칭인 이차형식이 드러난다. 그 이차형식을 만드는 행렬이 피셔 정보 행렬이다. 이 절에서는 그 행렬이 파라미터 공간 전체에 놓이는 "자(ruler)", 곧 리만 계량이 됨을 본다.

그리고 하나 더. 볼록함수 F(θ)와 접선 사이의 높이 차이가 브레그만 발산이고, 지수족에서는 그것이 KL과 일치한다. 브레그만 발산에서도 같은 일이 일어난다 — 두 점이 가까워지면, 높이 차이의 2차 근사는 ½ dθᵀ · ∇²F(θ) · dθ 가 된다. ∇²F(θ) — 볼록함수의 이계도함수.

같은 행렬에 세 갈래 길로 올라왔다. 첫째, KL의 발밑에서 만나는 이차형식. 둘째, 브레그만 발산의 발밑, 지수족의 자연모수에서 본 ∇²F. 셋째, 앞 절의 스코어의 분산. 세 길이 한 지점, Fisher 정보 행렬에서 합류한다.
...
고무판에 정사각형 격자를 그린다. 고무판을 늘리면 어떤 곳은 격자가 벌어지고 어떤 곳은 찌그러진다. 벌어진 곳에서의 한 칸은 "큰 거리", 찌그러진 곳에서의 한 칸은 "작은 거리". Fisher 행렬은 각 지점에서 격자가 얼마나 늘어나고 찌그러졌는지를 기록한 것이다.
...
계산하면 놀라운 답이 나온다. 이 자의 레비-치비타 접속이 주는 가우스 곡률은 어디서나 −1/2이다(다음 절에서 계산한다). 타원은 σ에 따라 수십 배로 커지고 작아지는데, 곡률은 모든 점에서 똑같다. 그리고 같은 공간을 e-접속으로 보면 곡률은 0이다(다음 절의 문제 4). "곡률"이라고 쓸 때는 어느 접속의 곡률인지 밝혀야 하는 이유다.
...
지수족에는 로그정규화자 F(θ)가 있다. 자연모수 θ에서 Fisher 정보 행렬은 F의 헤시안이다.
...
앞 절에서 스코어의 분산으로 정의한 Fisher 정보가, 지수족에서는 로그정규화자의 이계도함수이고 충분통계량의 공분산이다. 지수족의 스코어가 t(x) − E[t(x)]라서 그렇다.
...
이 장에서 우리는 ∇log p의 분산이 Fisher 정보임을 보았다. Fisher 정보 행렬 = E[∇log p · ∇log pᵀ]. "∇log p가 재료라면, 그 재료로 만든 분산이 파라미터 공간의 자, 곧 계량이 된다." 그리고 이 자로 잰 같은 크기의 한 걸음 가운데 손실을 가장 많이 줄이는 방향으로 걷는 것이 자연 기울기(natural gradient)다.

### 수확

"Fisher 정보가 자이고, ∇log p가 재료다. 자로 크기를 재고, ∇log p로 방향을 안다. 이 자로 덧셈의 길(확률을 섞는 길)과 곱셈의 길(로그를 섞는 길)의 길이를 재면 보통은 같지 않고, 둘 다 측지선보다 길다. 두 길은 가장 짧은 길이 아니라 각자의 접속에서 곧은 길이기 때문이다."
...
>
> 그 일을 한 것이 1945년의 Rao였고, 그 뒤를 이은 것이 1980년대의 Amari였다. Fisher가 만든 도구함의 각 도구들이 사실은 하나의 기하학적 구조의 여러 면이었다는 것을 밝혀내는 데 반세기가 더 걸린 것이다. 이 장에서 본 Čencov의 정리가 그 연결을 가장 짧게 말한다. 충분통계량으로 요약해도 변하지 않는 자는 Fisher 정보 하나뿐이라는 것.
>
...
우리 손에는 Fisher 정보라는 자가 하나 있다. 자는 하나다. 그리고 대칭이다. p에서 q로 재나 q에서 p로 재나, 발밑의 거리는 같다.

그런데 두 점 사이에는 길이 둘 있다. 덧셈의 길과 곱셈의 길. 자가 하나인데 길은 왜 둘인가. 길을 정하는 것은 자가 아니라 「무엇을 곧다고 부를지」의 규칙이기 때문이다. 그 규칙을 접속이라 부른다. 확률의 세계에는 자연스러운 곧음이 둘 있다. 섞어서 곧은 것과, 곱해서 곧은 것. 두 곧음은 하나의 Fisher 계량을 사이에 두고 쌍대로 마주 선다.
...
가중치 (0.4, 0.3, 0.3)은 심플렉스 위의 점이다. 와일드카드를 추가하면 심플렉스의 차원이 올라간다. 가중치를 바꾸면 심플렉스 위를 걷는다.
...
한 가지 조심할 곳이 있다. 이 말은 「성분을 고정한 혼합들의 모임」 안에서만 그대로 맞다. 가우시안족 안에서 기대모수 η의 직선을 따라 걸으면, 그 중간점은 가우시안이다. 그런데 두 가우시안의 혼합은 가우시안이 아니다. η-직선의 중간점은 혼합 그 자체가 아니라 혼합과 평균·분산이 같은 가우시안이다. 이 차이는 뒤의 문제 4에서 숫자로 본다.
...
베이즈 업데이트에서는 사전분포에 우도를 곱한다. 왜 덧셈이 아니라 곱셈인가? 섞는 것이 「모른다」의 표현이었다면, 곱하는 것은 무엇의 표현인가?
...
샘플 공간에서 분포를 섞고 곱하는 두 연산이 파라미터 공간에서 두 접속(m-접속과 e-접속)으로 번역된다. 아마리가 밝힌 것의 핵심은 이 두 접속이 대등한 지위로 마주 서 있다는 것이다. 하나가 다른 하나의 「그림자」다. 무지와 확신, 덧셈과 곱셈이 하나의 Fisher 계량을 사이에 두고 쌍대다. 계량이 둘인 것이 아니다. 자는 하나이고, 「곧음」의 규칙이 둘이다.
...
아니다. 전략을 바꾸면 된다. 복잡한 분포를 직접 다루는 대신, 다루기 쉬운 모형 안에서 「가장 가까운 점」을 찾는 것이다. 현실(p)을 지도(q)에 옮기는 것이다. 가까움은 KL로 잰다.

여기서 KL의 비대칭이 문제가 된다. KL(p‖q)와 KL(q‖p)는 다르다. 이 비대칭은 발산이라는 양의 성질이다. 자(계량)가 비대칭이라는 뜻이 아니다. 발밑에서는 두 방향이 같은 Fisher 이차식으로 줄어든다. 비대칭은 두 점이 멀리 떨어져 있을 때 드러나는 전역적인 성질이다.
...
KL(q‖p)를 최소화하면 — q가 심판이다. q가 높은 곳에서 p가 낮으면 벌이 크다. q는 p가 거의 0인 곳에 확률을 걸지 않으려 한다. 봉우리들이 충분히 떨어져 있으면, q는 봉우리 하나에 집중하는 좁은 답을 고른다 — e-사영. 그런데 이 답은 하나가 아닐 수 있다. 봉우리가 둘이면 어느 봉우리를 고르느냐에 따라 국소해가 여럿 생기고, 봉우리들이 가까우면 오히려 가운데에 걸친 넓은 답이 최적이다. 어느 쪽이 되는지는 봉우리 사이의 간격이 정한다.
...
모형 밖의 복잡한 분포 p를 모형 위의 한 점으로 옮기고 싶다. 그런데 「가장 가까운 점」을 KL의 어느 방향으로 재느냐에 따라 답이 달라지지 않는가?
...
실제 분포가 지수족에 속하지 않으면 어떻게 하나? 지수족 위에서 쌓은 도구를 분포에 그대로 쓸 수 없다면, 분포 쪽을 다루기 쉬운 모형 위로 옮겨 오는 수밖에 없다.
...
모형이 기대하는 충분통계량의 평균을 데이터의 평균에 맞추면 그것이 답이다. 가우시안이면 평균과 분산을, 이항분포면 성공 횟수의 평균을 맞춘다. 이 조건은 지수족일 때의 이야기다. 지수족이 아닌 모형에서는 MLE가 여전히 m-사영이지만, 평균이 맞는다는 보장은 없다(아래 문제 1).
...
두 방향 u, v의 Fisher 내적은 Σ u(x) v(x) / q(x)이다. u = p − q<sub>m</sub>, v = ∂<sub>i</sub>q를 넣으면 바로 위의 식이 된다. 「최소점이다」와 「p에서 온 m-측지선이 모형과 Fisher 직교한다」는 같은 말이다. 유클리드 직교가 아니다. 심플렉스 그림 위에서 눈으로 보면 비스듬하다.
...
첫 줄을 읽어 보자. 현실 p에서 모형 위의 아무 점 r까지의 KL은 「p에서 사영점까지」와 「사영점에서 r까지」의 합이다. 직각삼각형의 빗변이 두 변으로 나뉘듯이. 인수의 순서가 중요하다. p는 언제나 왼쪽, r은 언제나 오른쪽이다. 순서를 바꾸면 등식이 깨진다(아래 문제 3).

이 등식에서 두 가지가 바로 나온다. KL(q<sub>m</sub>‖r) ≥ 0이므로 q<sub>m</sub>이 정말로 최소점이다. 그리고 r이 사영점에서 멀어질수록 얼마나 손해인지가 정확히 KL(q<sub>m</sub>‖r)이다. EM 알고리즘은 이 분해를 한 걸음마다 쓴다.
...
두 점 사이의 길을 정하는 규칙을 접속이라 부른다. 자(Fisher 계량)는 하나이고, 둘인 것은 「곧음」의 규칙이다.
...
심플렉스에서 α = 0의 길은 눈에 보이는 모양이 있다. √p를 좌표로 쓰면 심플렉스는 구면의 한 조각이 된다. 그 위의 최단 경로는 대원의 호다. e-측지선도 m-측지선도 최단 경로가 아니다. 각자의 규칙으로 「곧게」 갈 뿐이다.
...
LoRA 병합이나 모델 수프는 두 모델의 파라미터를 평균 내서 하나로 합친다. 파라미터를 평균 내면 왜 되는가? 같은 두 점도 어떤 공간에 놓느냐에 따라 가까움과 멂이 달라진다. 그러면 질문을 정확히 바꿀 수 있다. 파라미터 공간에서의 평균은 분포 공간에서 어떤 길의 어떤 중간점인가? 「왜 되고 왜 안 되지?」가 「파라미터 공간의 직선이 분포 공간에서는 어떤 모양의 길이었는가?」로 바뀐다.
...
두 모델이 가까우면(KL 0.010) 세 중간점이 소수 둘째 자리까지 같다. 발밑에서는 모든 길이 하나의 Fisher 이차식으로 모이기 때문이다. 두 모델이 멀면(KL 2.405) 세 중간점이 눈에 띄게 갈라진다. 파라미터 평균이 잘 통하는 곳은, 무엇보다 두 모델이 분포로서 가까운 곳이다.
...
>
> 1963년, Csiszár는 마르코프 연쇄의 에르고딕성을 다룬 논문에서 이 양들을 하나의 가족 — f-divergence — 으로 묶었다. 볼록함수 f 하나를 고르면 발산 하나가 나온다. f(x) = x log x이면 KL, f(x) = (x−1)²이면 χ², f(x) = (√x − 1)²이면 헬링거(의 제곱). 「볼록함수마다 발산이 하나씩 태어난다」는 말의 정확한 형태가 이것이다.
>
...
>
> 그가 놓은 기초 — f-divergence와 I-사영 — 는 정보기하학에서 Amari의 쌍대 구조와 만나 사영과 교대 최소화의 기하학을 관통하는 뼈대가 되었다.
...
질문 하나로 시작하자. e-사영을 하고, 그 결과를 보고, 다시 m-사영을 하고, 또 그 결과를 보고 — 이 교대를 반복하면 어디에 도달하는가? 수렴하는가? 수렴한다면, 왜?
...
KL은 대칭도 아니고 삼각부등식도 깨진다. 그런 양이 어떻게 피타고라스 정리를 따르는가? 그리고 그게 왜 쓸모가 있는가?
...
현실 p가 있고, 모형들의 집합 M이 있다. M은 e-평탄하다고 하자. 자연모수 θ로 보면 곧은 면이라는 뜻이다(지수족). M 위에서 KL(p‖q)를 가장 작게 만드는 점을 q<sub>m</sub>이라 부른다. p의 m-사영점이다. 지수족에서는 충분통계량의 기댓값을 p와 맞추는 점이다.
...
지수족 안의 KL은 브레그만 발산이다. 브레그만 발산에는 세 점 사이의 정확한 항등식이 있다. 근사가 아니다. 1차 근사의 오차 같은 것이 아니라, 항 하나 빼지 않은 등식이다.
...
한쪽은 θ 좌표의 벡터, 한쪽은 η 좌표의 벡터다. θ와 η는 서로의 쌍대 좌표다. 그 짝지음으로 잰 내적이 0이다. 이것이 "쌍대 직교"이고, Fisher 계량으로 잰 직교와 같은 말이다.

"거리도 아닌 것"인 KL이 피타고라스 정리를 품고 있었다. 거리가 아니어서 쓸모없는 줄 알았는데, 볼록함수 F에서 태어난 발산이기 때문에 오히려 이 분해가 가능하다. 볼록함수의 그릇과 그 접선이 여기서 삼각형이 된다.
...
>
> 그런데 수렴 증명에는 구멍이 있었다. 1983년, C. F. Jeff Wu가 *Annals of Statistics*에서 그 결함을 짚고 올바른 증명을 다시 썼다. 우도의 값이 수렴한다는 것과, 파라미터의 수열이 수렴한다는 것과, 그 도착점이 국소 최댓값인지 정류점일 뿐인지는 서로 다른 질문이었다. Wu는 그 셋을 갈라 각각에 필요한 조건을 적었다. 이 장 뒤쪽의 「수렴하는 것과 수렴하지 않는 것」은 그 구분을 따른 것이다.
>
...
값이 내려가기만 한다면 EM은 어딘가에 도착한다. 그런데 무엇이 도착하는가? 값인가, 파라미터인가? 그리고 그 도착점은 가장 좋은 답인가?
...
"EM에서 수렴하는 것은 값이지 파라미터가 아니고, 도착하는 곳은 초기값이 정하는 정류점이다. 값의 수렴도 목적함수가 아래로 유계일 때만 보장된다."
...
앞에서 줄곧 눈에 밟히는 것이 있었다. log가 곱을 합으로 바꿀 때 나오고, 놀라움을 잴 때 나오고, 지수족의 골격에서도, 민감도를 잴 때도 나왔다. 데이터로 모형을 맞출 때는 로그우도로 또 나왔다. 매번 다른 이름으로. 매번 다른 이유로. 왜 같은 함수가 이렇게 많은 문을 열고 있는가? 우연인가, 필연인가?
...
**③ 부등식의 원천.** −log는 볼록하다. 할선이 항상 곡선 위에 있다는 간단한 사실(젠센 부등식)에서 KL ≥ 0이 나왔다. 그때는 log가 부등식의 원천이었다.

**④ 골격의 심장.** 지수족은 log를 씌우면 θ에 대해 1차식이 되는 가족이었다.
...
로그정규화자 F(θ)는 "지수들의 합의 log"이고, 그래서 볼록하다. 그 볼록성이 쌍대 좌표 η = ∇F(θ)를 선물했다. 그때는 log가 분포의 골격을 만드는 도구였다.

**⑤ 민감도의 재료.** 우리는 ∇log p를 만났다. 스코어다. ∇log p = ∇p / p 이므로, 이것은 확률의 변화를 절대량이 아니라 비율로 읽는다. 연봉 3000만원의 300만원 인상과 3억의 300만원 인상이 다르듯. 그 비율의 분산이 Fisher 정보였다. 그때는 log가 민감도를 공정하게 재는 도구였다.
...
## 거리의 세 얼굴: KL·브레그만·Fisher는 볼록함수 하나에서 나온다

log의 여섯 얼굴이 하나의 성질로 모였다. 그렇다면 분포 사이의 "거리"에 붙었던 세 이름 — KL 발산, 브레그만 발산, Fisher 계량 — 도 하나의 구조를 가리키고 있지 않을까? 지수족 안에서는 그렇다. 셋은 하나의 볼록함수 F가 보여주는 세 얼굴이다.
...
브레그만 발산은 "볼록함수와 접선 사이의 높이 차이." F(θ)의 그릇에서 접선까지의 간격. 그리고 지수족 안에서는 이것이 KL과 같았다. 인수의 순서를 뒤집어서.
...
Fisher 계량은 "두 점이 가까워지면 비대칭이 사라지며 드러나는 대칭 거리."
...
## 첸초프의 정리: 정보를 잃지 않는 옮기기가 Fisher 계량을 고른다

세 얼굴이 모두 발밑에서 Fisher 계량으로 모였다. 우연일까? 다른 자를 골랐어도 이 모든 이야기가 성립했을까, 아니면 Fisher 말고는 애초에 고를 자가 없었던 걸까? 이 물음에 답한 사람이 있다.
...
>
> "왜 Fisher 정보가 유일한 자연스러운 계량인가"라는 질문의 답이 "Čencov의 정리"라고 불리는 바로 이 정리다. 이 교재 전체에서 Fisher 정보가 특권적 위치를 차지하는 것 — 거리를 재고, 곡률을 정의하고, 사영의 직교를 재는 것 — 의 수학적 정당화가 첸초프에게서 나온다.
>
...
자리마다 따로 만든 도구들을 한 상자에 담으면, 정말로 서로 맞물릴까? 지금까지의 도구는 지수족 하나를 다루는 한 벌의 연장이어야 한다. 코드로 확인하는 것이 가장 정직하다. 한 클래스 안에 F, η, Fisher, F*, 브레그만, KL을 넣고, 장마다 따로 증명했던 등식들이 한 번에 성립하는지 본다.
...
KL = 브레그만(순서를 뒤집어서), 르장드르 쌍대, 음의 엔트로피, Fisher = Cov[t], 발밑 이차식이 한 객체 안에서 동시에 맞는다. 클래스에 새 t(x)와 k(x)만 넣으면 같은 연장이 다른 지수족에서도 그대로 돈다.

### 수확

"이 모든 것이 덧셈과 곱셈이었다. 덧셈은 무지의 방향이고, 곱셈은 확신의 방향이다. p에서 내려오는 m-측지선이 e-평탄한 모형과 직교해 KL이 피타고라스처럼 나뉘고, 교대 최소화가 목적함수의 값을 내려 보낸다. 그리고 그 사이를 번역한 것이 log였다."

지도가 완성되었다. 키 분포를 점 하나로 놓았을 때 시작된 여행이 여기서 하나의 그림이 된다. 마지막으로, 이 지도 위의 자가 좌표를 바꿔도 같은 자인지 손으로 확인해 보자.

### 문제 3. KL의 헤세 행렬은 좌표를 바꿔도 Fisher인가 (킬러)
...
| 연장 | 지수족 밖에서 | 쓰이는 곳 |
|---|---|---|
| KL 발산 | 어떤 두 분포 사이에서도 그대로 정의된다. 방향의 의미(누구의 눈으로 재는가)도 그대로다. | 디퓨전의 학습 목표, RLHF의 KL 벌칙 |
| m-사영 = 최대우도 | 교차엔트로피 학습은 여전히 KL(p̂‖q)를 줄이는 m-사영이다. 다만 답이 하나라는 보장은 사라진다. | 사전학습, SFT |
| e-사영 = 모드 찾기 | KL(q‖p)를 줄이는 쪽은 여전히 봉우리 하나를 고르는 경향이 있다. | 변분추론, 정책 최적화 |
| Fisher 계량 | 국소적으로는 여전히 KL의 발밑이다. 퇴화한 방향을 조심하며, 근사(대각, 블록)로 쓴다. | 자연 경사, 최적화기 설계 |
| 스코어 ∇log p | 정규화 상수를 몰라도 계산된다. log의 다섯 번째 얼굴이 주인공이 된다. | 스코어 매칭과 디퓨전 |
| 지수 기울이기 | 기준 분포에 exp(보상/β)를 곱하는 e-족 한 줄은 어떤 기준 분포에서도 성립한다. | 보상 최적 정책의 닫힌꼴 |
...
각 드래곤볼이 전파를 발산한다. 한 개의 볼이 만드는 신호 강도는 거리에 따라 가우시안으로 감쇠한다. 가까우면 강하고, 멀면 약하다. 7개의 신호가 합쳐지면 땅 위에 전파 강도 지도가 만들어진다. 봉우리가 7개인 지형.
...
"스코어"라는 이름은 모수 쪽에서도 쓰인다. 이름은 같지만 미분하는 변수가 다르다. 모수 쪽 스코어 ∇<sub>θ</sub> log p<sub>θ</sub>(x)는 모수 θ를 흔들어 보는 기울기다. 분포족 안에서 어느 쪽으로 움직이면 이 데이터가 더 그럴듯해지는가. 여기의 스코어 ∇ₓ log p(x)는 분포는 그대로 두고 점 x를 움직여 보는 기울기다. 평야 위에서 어느 쪽으로 걸으면 더 그럴듯한 곳에 닿는가. 둘 다 "로그를 미분한다"는 같은 가족이다. 이 장에서 스코어라고 하면 늘 ∇ₓ 쪽이다.
...
Z는 x와 무관한 상수라서 기울기가 0이다. 레이더는 전체 지도의 총량을 몰라도 만들 수 있다. 지수족에서도 로그정규화자 F(θ)를 계산하는 것이 늘 가장 어려운 일이었음을 떠올리면, 이것이 얼마나 큰 해방인지 알 수 있다. 디퓨전 모델이 밀도 대신 스코어를 배우는 첫째 이유가 이것이다.
...
제곱 오차의 최솟값이 조건부 기댓값이라는 사실은 "x<sub>t</sub>의 함수들이 이루는 공간 위로의 직교사영"이라는 기하학적 사실이다. 분포를 모형 위로 옮기는 사영과 모양이 같다. 큰 세계의 대상을 작은 세계의 가장 가까운 점으로 옮긴다. 다만 자가 다르다. 분포 사이의 e-사영, m-사영은 KL로 가까움을 쟀다. 스코어 매칭은 두 스코어 필드의 제곱 차이를 p<sub>t</sub>로 평균 낸 양, Fisher 발산으로 잰다.
...
드 브루인 항등식(엔트로피가 노이즈에 따라 변하는 속도가 Fisher 정보)의 KL판이다(Lyu, 2009). 두 번째 식은 첫 번째를 τ = 0부터 ∞까지 적분한 것이다. 안개가 무한히 짙으면 둘 다 같은 흐린 가우시안이 되어 KL이 0이다. 모든 안개 수준에서 스코어 매칭을 알맞은 가중치로 합하면, 그것이 곧 KL을 줄이는 일, 최대우도가 된다. 안개 수준 하나의 스코어 매칭은 KL로 재는 사영과 자가 다르지만, 모든 안개 수준을 합치면 같은 KL로 돌아온다.
...
변분추론과 같은 구조다. 잠재변수의 사후분포를 정확히 못 구하니, 하한을 올린다. 가운데 KL 항들은 가우시안끼리의 KL이라 평균의 차이만 남고, 정리하면 앞의 잡음 제거 스코어 매칭(노이즈 맞히기)에 시간별 가중치를 붙인 것이 된다. Ho 외는 그 가중치를 떼어 낸 단순한 손실이 더 좋은 그림을 만든다는 것을 실험으로 보였다. Kingma와 Gao(2023)는 여러 디퓨전 손실이 모두 "노이즈 수준별 ELBO의 가중 적분"으로 읽힌다는 것을 보였다. 앞의 KL 적분식과 같은 이야기를 변분추론 쪽에서 한 것이다.
...
|---|---|---|
| 드래곤볼 7개 | 데이터 분포의 모드들 | 매니폴드 가설 (볼이 놓인 곳) |
| 전파 강도 지도 | 확률밀도 p(x) | 혼합분포 |
| 전파의 감쇠 | 가우시안 커널 | — |
| 레이더 바늘 방향 | 스코어 ∇ₓ log p | 모수 쪽 스코어 ∇<sub>θ</sub> log p의 사촌 (미분 변수가 다르다) |
| 신호 총량을 몰라도 되는 레이더 | 정규화 상수 Z의 소거 | 지수족의 로그정규화자 |
| 안개의 농도 | 노이즈 수준 σ<sub>t</sub>, 합성곱 | 무지의 방향 |
| 레이더가 가리키는 곳 | 트위디 공식 E[x₀ ∣ x<sub>t</sub>] | EM E-step의 책임도 |
| 안개를 거꾸로 걷기 | 역방향 SDE (Anderson) | — |
| 바람 | 역방향 SDE의 노이즈 (확률흐름 ODE에는 없음) | — |
| 과거 기록으로 레이더 제작 | 잡음 제거 스코어 매칭 = Fisher 발산 최소화 | 사영 (자는 KL이 아니라 L²) |
...
디퓨전 모델은 매 지점의 방향(스코어, 로그 밀도의 기울기)을 배운다. 안개 속에서 레이더를 보며 한 걸음씩 걷는 참가자와 같다. 안개(노이즈 수준)가 바뀔 때마다 레이더를 재조정해야 한다.
...
그렇다면 어떤 속도장을 배워야 할까? 가장 단순한 것부터 보자. 조건부 플로우 매칭(conditional flow matching)의 가장 기본 형태는 노이즈 점 z와 데이터 점 x를 짝지어 직선으로 잇는 것이다.
...
짝을 최적 수송으로 지으면 표본 보간의 분포는 McCann(1997)의 변위 보간(displacement interpolation)이 된다. 와서스타인 거리가 재는 기하학의 측지선이다. 분포 공간의 두 길(덧셈, 곱셈)과 나란히 놓이는, 세 번째 종류의 "사이"다. 덧셈의 길의 그 직선이 쓰이는 것이 아니라, 모양이 닮은 다른 직선이 쓰인다.
...
같은 입력에 여러 정답이 오면 제곱 오차를 최소로 하는 한 값은 평균, 곧 조건부 기댓값이다. x<sub>t</sub>의 함수들이 이루는 공간 위로의 직교사영이다. 분포를 모형 위로 옮기는 사영과 모양이 같고, 자는 KL이 아니라 제곱 거리(L²)다. 디퓨전의 잡음 제거 스코어 매칭과 완전히 같은 구조다. 조건부 타깃으로 훈련하면 주변 타깃을 배운다.
...
(2)의 마지막 열 y/t + (1−t)/t·∇log p<sub>t</sub> 는 스코어로 속도를 만드는 식이다. 왜 맞아떨어지는지는 뒤에서 본다.
...
〔S06〕 **이서연:** 가능도를 다시 볼게요. z에 (1 − t)가 곱해져 있으니까 y의 조건부 분포는 N(tx, (1 − t)²)예요. 저는 분산을 1로 썼어요. 확률변수의 배율을 밀도에 반영 안 한, 문제 1이랑 같은 실수예요.
...
바람 세기를 바꿔도 도착 비율은 그대로다. 반면 ODE를 몇 스텝으로 푸느냐는 결과를 크게 바꾼다. 조건부 길은 직선이어도 주변 궤적이 휘어 있기 때문이다. 앞에서 본 OT 짝짓기와 reflow가 겨냥하는 것이 바로 이 스텝 수다.
...
"플로우 매칭의 프레임은 공간에 무관하다. 하늘의 차원만 바꾸면 같은 비행 프로그램이 작동한다. 비유였던 관절 인형이 여기서 실제가 된다."
...
분포를 바꾸는 방향은 두 가지다. 프롬프트의 와일드카드 {전투 | 일상 | 로맨스} 는 가능성을 넓히고(OR), 쉼표로 이어 붙인 조건 "존댓말, 세 문장 이내" 는 가능성을 좁힌다(AND). 넓히기는 분포를 섞는 덧셈(혼합)이고, 좁히기는 조건을 곱하는 곱셈이다. 분포의 공간에서 두 방향은 각각 덧셈의 길과 곱셈의 길, m-측지선과 e-측지선이 된다.
...
미리 한 가지를 못 박아 둔다. 이 장에서 기하학을 읽는 곳은 신경망의 파라미터 공간이 아니라 **출력 분포의 공간**이다. 수십억 개의 가중치는 θ 좌표도 η 좌표도 아니다. θ·η 같은 쌍대 좌표는 지수족 위에서만 정의된다. 언어모델의 가중치 공간에는 그런 좌표가 없다. 그래서 "파라미터가 η 직선을 따라 걷는다" 같은 말은 하지 않는다. 대신 모델이 내놓는 분포 π(y) 가 어디로 가는지를 본다.
...
프리트레인의 손실은 다음 토큰의 교차엔트로피다. 교차엔트로피는 엔트로피와 KL로 쪼개진다.
...
H(p) 는 모형이 어쩔 수 없는 상수다. 그러니 교차엔트로피를 줄이는 것은 KL(p‖q) 를 줄이는 것과 같다. KL(p‖q) 는 현실 p의 눈으로 본 지도 q의 부정확함이다. 모형이 될 수 있는 분포들(모형족) 가운데 KL(p‖q) 가 가장 작은 q 를 고르는 일을 m-사영이라 부른다. 최대가능도 추정(MLE)이 바로 데이터의 경험분포를 모형족으로 m-사영하는 일이다.
...
프리트레인 → SFT → 강화학습은 한 번씩 차례로 지나가는 파이프라인이다. 숨은 변수를 추정하는 EM 알고리즘처럼 두 단계를 여러 번 번갈아 되풀이하는 것이 아니다. 그리고 강화학습 단계도 두 종류가 있다. InstructGPT(Ouyang 외 2022)가 정착시킨 RLHF는 사람의 선호를 배운 보상 모형을 쓴다. RLVR은 정답 검사기가 보상을 준다. 보상의 출처가 다를 뿐, "보상을 올리되 참조에서 너무 멀어지지 말라"는 뼈대는 같다.
...
EM이 매번 목적함수를 줄이는 이유는 교대 최소화 자체에 있다. 각 단계가 한쪽을 고정하고 다른 쪽에서 최선을 고르니, 값이 나빠질 수 없다. KL의 피타고라스 관계는 그 감소량을 정확히 재 준다.
...
성공적인 프리셋은 표현하고 싶은 것들이 등장할 수 있게 하면서도(OR의 성과가 살아 있고) 등장하지 말아야 할 것들은 안 나오게 하는(AND의 성과가 살아 있는) 지점에서 멈춘 것이다. 넓힘과 좁힘이 더 이상 서로를 되돌리지 않는 지점. EM에서 KL이 더 이상 줄지 않는 정지점과 닮은 모양이다.
...
참조 정책에 "정답일 것"이라는 조건을 거는 것 — 참조 분포에 정답 집합의 지시함수를 곱하고 정규화하는 것이다. 쉼표로 조건을 붙이는 것, AND 그 자체다. 정답들 사이의 상대 비율은 참조가 준 그대로 남는다는 점도 눈여겨보자. 강화학습은 참조가 모르던 정답을 새로 만들지 않는다. 참조가 이미 가진 정답을 추려낼 뿐이다. (적어도 이 이상적인 최적해에서는 그렇다. 실제 학습은 모형족과 최적화의 한계 때문에 이 해에 정확히 가지 못한다.)
...
α → −1 이면 KL(p‖q): 목표 쪽에 무게, m-사영, mode-covering. α → +1 이면 KL(q‖p): 모형 쪽에 무게, e-사영, mode-seeking. α = 0 이면 2 Σ(√p − √q)², 헬링거 거리 제곱의 네 배 꼴로 대칭이다. α-발산은 "무엇을 곧은 길로 볼지"를 정하는 접속도 ±α 한 쌍으로 만든다. 그래서 이 다이얼은 발산의 다이얼이면서 동시에 곧음의 다이얼이기도 하다. α = 0 의 접속은 Fisher 계량의 레비-치비타 접속이다.
...
**이서연:** 두 분포가 가까우면 두 KL 모두 ½ dθᵀIdθ 로 가니까요. 가까운 곳에서는 KL이 대칭이 돼요. 멀어질수록 차이가 커져요.
...
"왜 어떤 파인튜닝은 병합이 잘 되고 어떤 파인튜닝은 병합이 안 되는가?"
...
프리트레인(OR)이 해당 영역의 봉우리를 이미 품고 있으면, 파인튜닝은 그 봉우리 근처에서 좁히는 것이다. 파라미터 변화가 작고, 출력 분포의 변화도 작다. Fisher 계량(파라미터를 바꿀 때 출력 분포가 얼마나 달라지는지로 재는 자)으로 재면 "가까운" 거리.

가중치를 평균하는 것은 파라미터 공간의 직선 보간이다. 이것을 m-측지선(분포의 혼합)과 헷갈리지 말자. 가중치의 평균이 만드는 분포는 두 분포의 혼합이 아니다. 신경망의 가중치는 θ 좌표도 η 좌표도 아니어서, 가중치 직선은 e-측지선도 m-측지선도 아니다.
...
학습률 0.01이 좁은 모델에서는 적당한 걸음인데 넓은 모델에서는 발산하는 도약이 된다면 — 눈금 자체를 다시 그려야 한다.

그 눈금이 무엇인지를 묻는 것이 이 장이다. 이 장에서 학습률은 lr 로 쓴다. η 는 이 책에서 기대모수의 이름이다.
...
같은 학습률이 폭에 따라 왜 다른 뜻을 갖는가? 좌표의 한 칸이 어디서나 같은 거리가 아니기 때문이다. 그 불균등함을 재는 자가 Fisher 정보 행렬이다. 가장 작은 예부터 보자.
...
Yang과 Hu(2021), Yang 외(2022)의 유도는 Fisher 계량에서 출발하지 않는다. 출발점은 이런 요구다. 폭을 무한대로 보내도, 학습 한 스텝이 각 층의 특징(은닉 활성값)을 Θ(1) 만큼 바꿔야 한다. 너무 작으면 특징이 사실상 얼어붙고(커널 영역), 너무 크면 폭발한다. 이 장 첫 절의 예가 그 계산의 한 조각이다. 정렬된 합 때문에 변화가 fan_in 배로 커지니, 학습률을 1/fan_in 로 줄인다.
...
"왜 자가 필요한가"를 아는 사람에게 μP와 Muon은 같은 질문의 두 가지 답이다: "파라미터 공간에서 공정한 한 걸음이란 무엇인가?" 그리고 그 답은 "어떤 노름으로 재느냐"를 먼저 정해야 나온다. Fisher 계량은 그 노름 후보 가운데 분포 공간이 직접 주는 하나다.

### 더 나아간 시도

Muon은 모든 특이값을 1로 만든다 — 등방적(isotropic)이다. 그런데 Fisher 계량은 방향마다 눈금이 다른 자다. 이퀄라이저의 슬라이더마다 소리를 바꾸는 민감도가 다르듯이. 정규분포 N(μ, σ²) 만 해도 I = diag(1/σ², 2/σ²) 로, μ 방향과 σ 방향의 눈금이 다르고 σ 가 작을수록 두 눈금이 함께 촘촘해진다.

FISMO(Xu, Yan, Zhang, 2026년 1월)는 이 지점을 겨눈다. Muon의 엄격한 등방성이 곡률 정보를 버린다는 문제의식에서, 크로네커 인자로 만든 Fisher 계량 아래의 신뢰 영역 문제로 업데이트를 세우고 모멘텀 직교화와 Fisher 구조의 전조건을 결합했다. "Fisher 계량 + Muon의 직교화"의 결합이다.

이 방향은 아직 활발히 연구 중이다. 우리가 배운 도구 — Fisher 계량, 스펙트럼 구조, 자연 기울기 — 가 최신 옵티마이저 연구의 뼈대에 깔려 있다는 것이 이 장의 메시지다.

### 수확

"μP는 스케일링 규칙으로, Muon은 직교화로, 같은 질문에 답한다: '파라미터 공간에서 공정한 한 걸음이란 무엇인가?' 답은 어떤 노름으로 재느냐에 달려 있고, Fisher 계량은 그 노름을 분포 공간에서 가져오는 방법이다."

너비가 바뀌면 같은 걸음이 출력에 만드는 변화가 바뀐다. μP는 층마다 그 변화를 폭과 무관하게 맞추는 처방이고, Muon은 스펙트럼 노름으로 잰 걸음을 일정하게 만드는 처방이다. 분포의 공간에서 가져온 자(ruler)가 현실의 문제에서 작동한다.
...
`,ke=(a,t)=>Q.lazy(()=>a().then(r=>({default:r[t]}))),Hn=[{id:"00",title:"서문",slug:"preface",md:Nm,vizMap:{}},{id:"01",title:"왜 정보기하학인가",slug:"why-infogeo",md:Rm,vizMap:{"ch01/softmax":ke(()=>we(()=>import("./ch01-why-fvsQjI1X.js"),__vite__mapDeps([0,1])),"SoftmaxTab"),"ch01/cramer-rao":ke(()=>we(()=>import("./ch01-why-fvsQjI1X.js"),__vite__mapDeps([0,1])),"CramerRaoTab")}},{id:"02",title:"점",slug:"point",md:Km,vizMap:{"ch02/mu-sigma":ke(()=>we(()=>import("./ch02-point-a8C4d8Pe.js"),__vite__mapDeps([2,1])),"MuSigmaTab"),"ch02/simplex":ke(()=>we(()=>import("./ch02-point-a8C4d8Pe.js"),__vite__mapDeps([2,1])),"SimplexTab")}},{id:"03",title:"거리",slug:"distance",md:Dm,vizMap:{"ch03/euclidean-vs-kl":ke(()=>we(()=>import("./ch03-distance-CBgNOtXI.js"),__vite__mapDeps([3,1,4,5,6,7])),"EuclideanVsKLTab"),"ch03/asymmetry":ke(()=>we(()=>import("./ch03-distance-CBgNOtXI.js"),__vite__mapDeps([3,1,4,5,6,7])),"AsymmetryTab"),"ch03/fisher-local":ke(()=>we(()=>import("./ch03-distance-CBgNOtXI.js"),__vite__mapDeps([3,1,4,5,6,7])),"FisherLocalTab")}},{id:"04",title:"길",slug:"paths",md:Im,vizMap:{"ch04/two-paths":ke(()=>we(()=>import("./ch04-paths-cQWVTyiJ.js"),__vite__mapDeps([8,1])),"TwoPathsTab"),"ch04/midpoint":ke(()=>we(()=>import("./ch04-paths-cQWVTyiJ.js"),__vite__mapDeps([8,1])),"MidpointTab"),"ch04/color-interpolation":ke(()=>we(()=>import("./ch04-paths-cQWVTyiJ.js"),__vite__mapDeps([8,1])),"ColorInterpolationTab")}},{id:"04z",title:"전환 — 같은 세계, 다른 눈",slug:"transition-1",md:Bm,vizMap:{}},{id:"05",title:"놀라움과 정보",slug:"surprise",md:Pm,vizMap:{"ch05/surprise":ke(()=>we(()=>import("./ch05-surprise-and-information-CTrxjltw.js"),__vite__mapDeps([9,1])),"SurpriseTab"),"ch05/entropy-simplex":ke(()=>we(()=>import("./ch05-surprise-and-information-CTrxjltw.js"),__vite__mapDeps([9,1])),"EntropySimplexTab"),"ch05/cross-entropy":ke(()=>we(()=>import("./ch05-surprise-and-information-CTrxjltw.js"),__vite__mapDeps([9,1])),"CrossEntropyTab"),"ch05/convexity-kl":ke(()=>we(()=>import("./ch05-surprise-and-information-CTrxjltw.js"),__vite__mapDeps([9,1])),"ConvexityTab")}},{id:"06",title:"볼록함수의 쌍대",slug:"convex-duality",md:Om,vizMap:{"ch06/convexity":ke(()=>we(()=>import("./ch06-convex-duality-DOJL2y6W.js"),__vite__mapDeps([10,1,4,6])),"ConvexityTab"),"ch06/jensen":ke(()=>we(()=>import("./ch06-convex-duality-DOJL2y6W.js"),__vite__mapDeps([10,1,4,6])),"JensenTab"),"ch06/legendre":ke(()=>we(()=>import("./ch06-convex-duality-DOJL2y6W.js"),__vite__mapDeps([10,1,4,6])),"LegendreTab"),"ch06/fenchel-young":ke(()=>we(()=>import("./ch06-convex-duality-DOJL2y6W.js"),__vite__mapDeps([10,1,4,6])),"FenchelYoungTab")}},{id:"06z",title:"전환 — 두 눈을 동시에",slug:"transition-2",md:Hm,vizMap:{}},{id:"07",title:"지수족",slug:"exponential-family",md:jm,vizMap:{"ch07/flashcards":ke(()=>we(()=>import("./ch07-exponential-family-flashcards-CDvsj8wy.js"),__vite__mapDeps([11,1,4,12,6])),"FlashcardsTab"),"ch07/two-handles":ke(()=>we(()=>import("./ch07-exponential-family-flashcards-CDvsj8wy.js"),__vite__mapDeps([11,1,4,12,6])),"TwoHandlesTab"),"ch07/moment-match":ke(()=>we(()=>import("./ch07-exponential-family-flashcards-CDvsj8wy.js"),__vite__mapDeps([11,1,4,12,6])),"MomentMatchTab"),"ch07/bregman":ke(()=>we(()=>import("./ch07-exponential-family-flashcards-CDvsj8wy.js"),__vite__mapDeps([11,1,4,12,6])),"BregmanTab")}},{id:"08",title:"구부러진 땅",slug:"curved-land",md:Vm,vizMap:{"ch08/circle-deficit":ke(()=>we(()=>import("./ch08-curved-land-DhU7kdWG.js"),__vite__mapDeps([13,1,6,12])),"CircleDeficitTab"),"ch08/holonomy":ke(()=>we(()=>import("./ch08-curved-land-DhU7kdWG.js"),__vite__mapDeps([13,1,6,12])),"HolonomyTab")}},{id:"09",title:"파라메터 공간의 곡률",slug:"fisher-information",md:$m,vizMap:{"ch09/sensitivity":ke(()=>we(()=>import("./ch09-fisher-information-qYSxiNXK.js"),__vite__mapDeps([14,1,4,6])),"SensitivityTab"),"ch09/fisher-rao-distance":ke(()=>we(()=>import("./ch09-fisher-information-qYSxiNXK.js"),__vite__mapDeps([14,1,4,6])),"FisherRaoDistanceTab"),"ch09/metric-ellipse":ke(()=>we(()=>import("./ch09-fisher-information-qYSxiNXK.js"),__vite__mapDeps([14,1,4,6])),"MetricEllipseTab")}},{id:"10",title:"무지와 확신",slug:"ignorance",md:Um,vizMap:{"ch10/mixture-entropy":ke(()=>we(()=>import("./ch10-ignorance-confidence-Bb2GheD7.js"),__vite__mapDeps([15,1])),"MixtureEntropyTab"),"ch10/bayes-path":ke(()=>we(()=>import("./ch10-ignorance-confidence-Bb2GheD7.js"),__vite__mapDeps([15,1])),"BayesPathTab")}},{id:"11",title:"추론의 기하학",slug:"geometry-of-inference",md:Gm,vizMap:{"ch11/gauss-fit":ke(()=>we(()=>import("./ch11-geometry-of-inference-Bgup5VCc.js"),__vite__mapDeps([16,1])),"GaussFitTab"),"ch11/simplex-projection":ke(()=>we(()=>import("./ch11-geometry-of-inference-Bgup5VCc.js"),__vite__mapDeps([16,1])),"SimplexProjectionTab"),"ch11/alpha-paths":ke(()=>we(()=>import("./ch11-geometry-of-inference-Bgup5VCc.js"),__vite__mapDeps([16,1])),"AlphaPathsTab")}},{id:"12",title:"수렴",slug:"convergence",md:Wm,vizMap:{"ch12/pythagoras":ke(()=>we(()=>import("./ch12-convergence-CopxsIVc.js"),__vite__mapDeps([17,1,6,12])),"PythagorasTab"),"ch12/em-convergence":ke(()=>we(()=>import("./ch12-convergence-CopxsIVc.js"),__vite__mapDeps([17,1,6,12])),"EMConvergenceTab")}},{id:"13",title:"전체 지도",slug:"full-map",md:Xm,vizMap:{"ch13/three-faces":ke(()=>we(()=>import("./ch13-full-map-7EnTNSHM.js"),__vite__mapDeps([18,1,12,6])),"ThreeFacesTab")}},{id:"13z",title:"전환 — 도구를 들고 세계로",slug:"transition-3",md:Zm,vizMap:{}},{id:"14",title:"디퓨전",slug:"diffusion",md:Qm,vizMap:{"ch14/score-field":ke(()=>we(()=>import("./ch14-diffusion-DV7_zmRF.js"),__vite__mapDeps([19,1])),"ScoreFieldTab"),"ch14/reverse-diffusion":ke(()=>we(()=>import("./ch14-diffusion-DV7_zmRF.js"),__vite__mapDeps([19,1])),"ReverseDiffusionTab"),"ch14/noise-annealing":ke(()=>we(()=>import("./ch14-diffusion-DV7_zmRF.js"),__vite__mapDeps([19,1])),"NoiseAnnealingTab")}},{id:"15",title:"플로우 매칭",slug:"flow-matching",md:Ym,vizMap:{"ch15/velocity-field":ke(()=>we(()=>import("./ch15-flow-matching-BF6NVV4M.js"),__vite__mapDeps([20,1,19])),"VelocityFieldTab"),"ch15/ot-matching":ke(()=>we(()=>import("./ch15-flow-matching-BF6NVV4M.js"),__vite__mapDeps([20,1,19])),"OTMatchingTab"),"ch15/comparison":ke(()=>we(()=>import("./ch15-flow-matching-BF6NVV4M.js"),__vite__mapDeps([20,1,19])),"ComparisonTab")}},{id:"16",title:"넓히기와 좁히기",slug:"broadening-narrowing",md:Jm,vizMap:{"ch16/tilt":ke(()=>we(()=>import("./ch16-broadening-narrowing-BCthHPjZ.js"),__vite__mapDeps([21,1,6,7,5,12])),"TiltTab"),"ch16/pass-at-k":ke(()=>we(()=>import("./ch16-broadening-narrowing-BCthHPjZ.js"),__vite__mapDeps([21,1,6,7,5,12])),"PassAtKTab"),"ch16/alpha-fit":ke(()=>we(()=>import("./ch16-broadening-narrowing-BCthHPjZ.js"),__vite__mapDeps([21,1,6,7,5,12])),"AlphaFitTab")}},{id:"17",title:"스케일링",slug:"scaling",md:e5,vizMap:{"ch17/lr-transfer":ke(()=>we(()=>import("./ch17-scaling-DQPNW8PD.js"),__vite__mapDeps([22,1,6,5])),"LRTransferTab"),"ch17/newton-schulz":ke(()=>we(()=>import("./ch17-scaling-DQPNW8PD.js"),__vite__mapDeps([22,1,6,5])),"NewtonSchulzTab")}},{id:"A",title:"에필로그",slug:"epilogue",md:t5,vizMap:{}}];function vo(a){const t=a.split(`
...
`)}}function wu(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Xr=wu();function o2(a){Xr=a}var $r={exec:()=>null};function Te(a,t=""){let r=typeof a=="string"?a:a.source,o={replace:(i,u)=>{let p=typeof u=="string"?u:u.source;return p=p.replace(Nt.caret,"$1"),r=r.replace(i,p),o},getRegex:()=>new RegExp(r,t)};return o}var n5=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),Nt={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:a=>new RegExp(`^( {0,3}${a})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:a=>new RegExp(`^ {0,${Math.min(3,a-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:a=>new RegExp(`^ {0,${Math.min(3,a-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:a=>new RegExp(`^ {0,${Math.min(3,a-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:a=>new RegExp(`^ {0,${Math.min(3,a-1)}}#`),htmlBeginRegex:a=>new RegExp(`^ {0,${Math.min(3,a-1)}}<(?:[a-z].*>|!--)`,"i"),blockquoteBeginRegex:a=>new RegExp(`^ {0,${Math.min(3,a-1)}}>`)},r5=/^(?:[ \t]*(?:\n|$))+/,a5=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,l5=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Da=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,o5=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,ku=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,i2=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,s2=Te(i2).replace(/bull/g,ku).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),i5=Te(i2).replace(/bull/g,ku).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Su=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,s5=/^[^\n]+/,_u=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,u5=Te(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",_u).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),c5=Te(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,ku).getRegex(),bo="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Lu=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,p5=Te("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Lu).replace("tag",bo).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),u2=Te(Su).replace("hr",Da).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",bo).getRegex(),f5=Te(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",u2).getRegex(),zu={blockquote:f5,code:a5,def:u5,fences:l5,heading:o5,hr:Da,html:p5,lheading:s2,list:c5,newline:r5,paragraph:u2,table:$r,text:s5},Qp=Te("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Da).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",bo).getRegex(),d5={...zu,lheading:i5,table:Qp,paragraph:Te(Su).replace("hr",Da).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Qp).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",bo).getRegex()},h5={...zu,html:Te(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Lu).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:$r,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:Te(Su).replace("hr",Da).replace("heading",` *#{1,6} *[^
]`).replace("lheading",s2).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},m5=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,x5=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,c2=/^( {2,}|\\)\n(?!\s*$)/,g5=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,yo=/[\p{P}\p{S}]/u,Eu=/[\s\p{P}\p{S}]/u,p2=/[^\s\p{P}\p{S}]/u,v5=Te(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Eu).getRegex(),f2=/(?!~)[\p{P}\p{S}]/u,b5=/(?!~)[\s\p{P}\p{S}]/u,y5=/(?:[^\s\p{P}\p{S}]|~)/u,d2=/(?![*_])[\p{P}\p{S}]/u,w5=/(?![*_])[\s\p{P}\p{S}]/u,k5=/(?:[^\s\p{P}\p{S}]|[*_])/u,S5=Te(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",n5?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),h2=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,_5=Te(h2,"u").replace(/punct/g,yo).getRegex(),L5=Te(h2,"u").replace(/punct/g,f2).getRegex(),m2="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",z5=Te(m2,"gu").replace(/notPunctSpace/g,p2).replace(/punctSpace/g,Eu).replace(/punct/g,yo).getRegex(),E5=Te(m2,"gu").replace(/notPunctSpace/g,y5).replace(/punctSpace/g,b5).replace(/punct/g,f2).getRegex(),F5=Te("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,p2).replace(/punctSpace/g,Eu).replace(/punct/g,yo).getRegex(),M5=Te(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,d2).getRegex(),T5="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",q5=Te(T5,"gu").replace(/notPunctSpace/g,k5).replace(/punctSpace/g,w5).replace(/punct/g,d2).getRegex(),A5=Te(/\\(punct)/,"gu").replace(/punct/g,yo).getRegex(),C5=Te(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),N5=Te(Lu).replace("(?:-->|$)","-->").getRegex(),R5=Te("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",N5).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),uo=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,K5=Te(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label",uo).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),x2=Te(/^!?\[(label)\]\[(ref)\]/).replace("label",uo).replace("ref",_u).getRegex(),g2=Te(/^!?\[(ref)\](?:\[\])?/).replace("ref",_u).getRegex(),D5=Te("reflink|nolink(?!\\()","g").replace("reflink",x2).replace("nolink",g2).getRegex(),Yp=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Fu={_backpedal:$r,anyPunctuation:A5,autolink:C5,blockSkip:S5,br:c2,code:x5,del:$r,delLDelim:$r,delRDelim:$r,emStrongLDelim:_5,emStrongRDelimAst:z5,emStrongRDelimUnd:F5,escape:m5,link:K5,nolink:g2,punctuation:v5,reflink:x2,reflinkSearch:D5,tag:R5,text:g5,url:$r},I5={...Fu,link:Te(/^!?\[(label)\]\((.*?)\)/).replace("label",uo).getRegex(),reflink:Te(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",uo).getRegex()},Gs={...Fu,emStrongRDelimAst:E5,emStrongLDelim:L5,delLDelim:M5,delRDelim:q5,url:Te(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",Yp).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:Te(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",Yp).getRegex()},B5={...Gs,br:Te(c2).replace("{2,}","*").getRegex(),text:Te(Gs.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Zl={normal:zu,gfm:d5,pedantic:h5},La={normal:Fu,gfm:Gs,breaks:B5,pedantic:I5},P5={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Jp=a=>P5[a];function Sn(a,t){if(t){if(Nt.escapeTest.test(a))return a.replace(Nt.escapeReplace,Jp)}else if(Nt.escapeTestNoEncode.test(a))return a.replace(Nt.escapeReplaceNoEncode,Jp);return a}function ef(a){try{a=encodeURI(a).replace(Nt.percentDecode,"%")}catch{return null}return a}function tf(a,t){var u;let r=a.replace(Nt.findPipe,(p,d,x)=>{let g=!1,y=d;for(;--y>=0&&x[y]==="\\";)g=!g;return g?"|":" |"}),o=r.split(Nt.splitPipe),i=0;if(o[0].trim()||o.shift(),o.length>0&&!((u=o.at(-1))!=null&&u.trim())&&o.pop(),t)if(o.length>t)o.splice(t);else for(;o.length<t;)o.push("");for(;i<o.length;i++)o[i]=o[i].trim().replace(Nt.slashPipe,"|");return o}function za(a,t,r){let o=a.length;if(o===0)return"";let i=0;for(;i<o&&a.charAt(o-i-1)===t;)i++;return a.slice(0,o-i)}function O5(a,t){if(a.indexOf(t[1])===-1)return-1;let r=0;for(let o=0;o<a.length;o++)if(a[o]==="\\")o++;else if(a[o]===t[0])r++;else if(a[o]===t[1]&&(r--,r<0))return o;return r>0?-2:-1}function H5(a,t=0){let r=t,o="";for(let i of a)if(i==="	"){let u=4-r%4;o+=" ".repeat(u),r+=u}else o+=i,r++;return o}function nf(a,t,r,o,i){let u=t.href,p=t.title||null,d=a[1].replace(i.other.outputLinkReplace,"$1");o.state.inLink=!0;let x={type:a[0].charAt(0)==="!"?"image":"link",raw:r,href:u,title:p,text:d,tokens:o.inlineTokens(d)};return o.state.inLink=!1,x}function j5(a,t,r){let o=a.match(r.other.indentCodeCompensation);if(o===null)return t;let i=o[1];return t.split(`
...
`,a=a.substring(K.length+1),y=!0),!y){let P=this.rules.other.nextBulletRegex(A),V=this.rules.other.hrRegex(A),Z=this.rules.other.fencesBeginRegex(A),re=this.rules.other.headingBeginRegex(A),ue=this.rules.other.htmlBeginRegex(A),ce=this.rules.other.blockquoteBeginRegex(A);for(;a;){let me=a.split(`
